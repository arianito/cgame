...
static const Rot2 rot2_identity = {0, 1};

#define rot2(cos, sin) ((Rot2){cos, sin})
#define rot2f(deg) (rot2(sindf(deg), cosdf(deg)))
...
inline static Rot2 rot2_mul(Rot2 q, Rot2 r) { return rot2(q.sin * r.cos + q.cos * r.sin, q.cos * r.cos - q.sin * r.sin); }
inline static Rot2 rot2_unmul(Rot2 q, Rot2 r) { return rot2(q.cos * r.sin - q.sin * r.cos, q.cos * r.cos + q.sin * r.sin); }
