...
#define rgb(r, g, b) ((Color){r / 255.0, g / 255.0, b / 255.0, 1})
#define rgba(r, g, b, a) ((Color){r / 255.0, g / 255.0, b / 255.0, 1})
...
static const Color color_blue = {11 / 255.0, 96 / 255.0, 176 / 255.0, 1};
static const Color color_blue2 = {64 / 255.0, 162.0 / 255.0, 216 / 255.0, 1};
